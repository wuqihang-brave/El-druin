...
maps into a rank-at-most-2 subspace of $\mathfrak{so}(8)$ under the hat map
...
\begin{itemize}
  ...
  \item \textbf{Object Properties}: \texttt{owl:ObjectProperty} declarations for
    \texttt{hasDomain}, \texttt{hasMechanismClass}, \texttt{inversePattern} (declared \texttt{owl:SymmetricProperty}, encoding that if pattern $A$ is the inverse of pattern $B$, then $B$ is the inverse of $A$),
