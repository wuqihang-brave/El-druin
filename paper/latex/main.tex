...
normalised against a fixed domain baseline of $n_d = 7$ (the total
...
The authors used large language model assistance (GPT-4o) solely as a constrained natural-language renderer within the EL-DRUIN pipeline, as described in Section~3. No generative AI tools were used in the preparation of this manuscript text, figures, or experimental results.
