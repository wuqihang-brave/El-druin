...
def write_markdown(rows: List[Dict[str, Any]], output: Path) -> None:
    ...
    lines += [
        ...
        "A GPT-5.1 (PolyU GenAI, 2026) confidence figure is a free-text assertion with no auditable derivation.",
        "",
        ...
        "GPT-5.1 (PolyU GenAI, 2026) outputs vary across runs (σ > 0 across N=5 samples).",
        "",
        ...
        "(CJK guard), and internal jargon.  GPT-5.1 (PolyU GenAI, 2026) has no equivalent enforcement layer.",
        "",
    ]
